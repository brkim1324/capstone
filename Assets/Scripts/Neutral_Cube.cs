...
public class Neutral_Cube : MonoBehaviour
{
    ...
    //difficulty 1: kindergarten... 2: teen   3: early adult  4: adult
    ...
    void Update()
    {
       ...
       PlayerNearBy();
        ...
        if (globalScript.GetComponent<Global>().CapFriends >= 5 && globalScript.GetComponent<Global>().CubeFriends >= 5)
        {
            Hostile();
        }
     ...
     //   }
        ...
        if (col.gameObject.tag == "PColor")
        {
            ...
            if (NeutralState == 1 && hitNumber == 6)
            {
                ...
                bossScript.GetComponent<BossCap>().agreements += 1;
                Friendly();
            }
            ...
            if (HostileState == 1 && NeutralState == 1 && hitNumber >= 10)
            {
                Friendly();
            }
